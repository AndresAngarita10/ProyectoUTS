...
<?php 
    ...
    try {
        ...
        if (isset($_POST['busqueda'])) {
            ...
            $tabla = $ControlModelo->getRemisionXCedulaTerm($control);

        }else{
            $tabla = $ControlModelo->getAllRemisionFinalizado();
        }
            ...
            <div id="fomr" class="d-flex justify-content-center align-items-center">
                <div>
                    <div id="contenedor" class="row">
                        ...
                        <h1 align="center" style="margin-top: 10px;" >Referencia y Contra Referencia Finalizado</h1>
                                ...
                                <form class="form-inline my-2 my-lg-0" method="POST" action="../../controlador/auditor/AuditorControlador.php">
                                    ...
                                    <input hidden class="form-control rounded-5 mr-sm-2" autocomplete="off" placeholder="" value="<?php echo($_POST['ccAuditor']); ?>"
                                        ...
                                        name="boton" id="boton" value="buscedulaTerm">Buscar</button>
                                </form>
                                </div>
                                <br />
                        ...
                        <tr>
                            ...
                            <th scope="col">Origen (Hospital)</th>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div class="input-group mb-0">
                                                    ...
                                                    <input hidden  id="examen2" name="examen2" value="<?php echo("SI"); ?>">
