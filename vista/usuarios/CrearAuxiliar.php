    ...
    <main>
        <section>
            ...
            <form action="../../controlador/usuarios/UsuariosControl.php" method="post" enctype="multipart/form-data" name="form1">
                ...
                <?php if($mod == "1"){
                    ?>
                      <button class="btn btn-info btn-success my-2 my-sm-0 rounded-2" name="boton" value="ActualizarAuxiliar" 
                      onclick="return confirm('Esta seguro de Enviar?')">Actualizar</button>
                    <?php

                } else { ?>
                
                    <button class="btn btn-info btn-success my-2 my-sm-0 rounded-2" name="boton" value="GuardarAuxiliar" 
