...
?>
    ...
    <main>
            ...
            <form action="../../controlador/usuarios/UsuariosControl.php" method="post" enctype="multipart/form-data" name="form1">
                    ...
                    <div class="field">
                        <select id="tipoDocumento" name="tipoDocumento"  required style="width: 350px;">
                                        <option  disabled>Seleccione Tipo Documento</option>
        ...
        ?>
                    ...
                    <?php if($mod == "1"){
                    ?>
                      <button class="btn btn-info btn-success my-2 my-sm-0 rounded-2" name="boton" value="ActualizarAditor" 
                      onclick="return confirm('Esta seguro de Enviar?')">Actualizar</button>
                    <?php

                } else { ?>       
                
                    <button class="btn btn-info btn-success my-2 my-sm-0 rounded-2" name="boton" value="GuardarAuditor" 
