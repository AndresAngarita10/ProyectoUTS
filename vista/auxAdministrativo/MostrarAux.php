...
<?php 
    ...
    try {
        $ControlModelo = new ModeloAuxiliar();
        $tabla = $ControlModelo->getAux();
            ...
            <div id="fomr" class="d-flex justify-content-center align-items-center">
                <div>
                    <div id="contenedor" class="row">
                        ...
                        <h1 align="center" style="margin-top: 10px;" >Auxiliar Administrativo</h1>
                                ...
                                <form class="form-inline my-2 my-lg-0" method="POST" action="NuevoAuxAdministrativo.php">
                                    

                                        <button class="btn btn-primary btn-success my-2 my-sm-0 rounded-5" type="submit"
                                        name="boton" id="boton"  value="agregarAux">Agregar Nuevo Auxiliar</button>
                                </form>
                                </div>
                        ...
                        ?> 
                        <form method="POST" action="../../controlador/auxAdministrativo/AuxAdministrativoControl.php">
                            <tbody>
                                <tr>
                                        ...
                                        <div class="input-group mb-0">
                                                    ...
                                                    <div >
                                                        ...
                                                        <button class="<?php if($valor->getActivo()==0){echo("btn btn-danger");}else{echo("btn btn-success");} ?>"  
                                                         type="submit" value="<?php if($valor->getActivo()==0){echo("activarAux");} else { echo("desactivarAux"); } ?>" id="boton" name="boton">
                                                ...
                                                <div class="input-group mb-0">
                                                    ...
                                                    <div >
                                                        ...
                                                        <button class="<?php if($_POST['activo']==0){echo("btn btn-danger");}else{echo("btn btn-success");} ?>"  
                                                         type="submit" value="<?php if($_POST['activo']==0){echo("activarAux");} else { echo("desactivarAux"); } ?>" id="boton" name="boton">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
                                                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                                            <path fill-rule="evenodd" d="M15.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                                                            </svg>
