...
<body>   
    <main>
        <section>
            <h1>Formulario de Registro de Examen Fisico del Paciente</h1>
            ...
            <div class="textbox">
                ...
                <div class="field">
                    ...
                    <div>
                        <div class="textbox" id="texto1">
                            ...
                            <textarea style="height: 45px;" name="actitud" id="actitud"></textarea>
                        </div>
                    </div>
                ...
                <div class="field">
                    ...
                    <div>
                        <div class="textbox" id="texto1">
                            ...
                            <textarea style="height: 45px;" name="decubito" id="decubito"></textarea>
                        </div>
                    </div>
                ...
                <div class="field">
                    ...
                    <div>
                        <div class="textbox" id="texto1">
                            ...
                            <textarea style="height: 45px;" name="marcha" id="marcha"></textarea>
                        </div>
                    </div>
                ...
                <div class="field">
                    ...
                    <div>
                        <div class="textbox" id="texto1">
                            ...
                            <textarea style="height: 45px;" name="aspecto" id="aspecto"></textarea>
                        </div>
                    </div>
                ...
                <div class="field">
                    ...
                    <div>
                        <div class="textbox" id="texto1">
                            ...
                            <textarea style="height: 45px;" name="lesiones" id="lesiones"></textarea>
                        </div>
                    </div>
                ...
                <div class="field">
                    ...
                    <div>
                        <div class="textbox" id="texto1">
                            ...
                            <textarea style="height: 45px;" name="impresionGeneral" id="impresionGeneral"></textarea>
                        </div>
                    </div>
                ...
                <div class="submit">
                    <button name="boton" value="GuardarHistoriaFase4" 
