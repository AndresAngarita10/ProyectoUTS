...
<?php 
    ...
    try {
        $ControlModelo = new ModeloMedico();
        $tabla = $ControlModelo->getMedicos();
            ...
            <div id="fomr" class="d-flex justify-content-center align-items-center">
                <div>
                    <div id="contenedor" class="row">
                        ...
                        <h1 align="center" style="margin-top: 10px;" >Medicos</h1>
                                ...
                                <form class="form-inline my-2 my-lg-0" method="POST" action="../../controlador/medico/MedicoControl.php">
                                    <input class="form-control rounded-5 mr-sm-2" autocomplete="off" placeholder="Buscar por cedula" 
                                        ...
                                        <button class="btn btn-primary btn-success my-2 my-sm-0 rounded-5" type="submit"
                                ...
                                <form class="form-inline my-2 my-lg-0" method="POST" action="NuevoMedico.php">
                                    

                                        <button class="btn btn-primary btn-success my-2 my-sm-0 rounded-5" type="submit"
                                        name="boton" id="boton"  value="agregarMedico">Agregar Nuevo Medico</button>
                                </form>
                                </div>
                        ...
                        <tr>
                            ...
                            <th scope="col">Especialidad <!-- <a type="button" style="margin-left: 100px;" class="btn btn-success rounded-5" href="VenderProducto.php?pagina=1&&cedula=<?php //echo($cedula); ?>">Finalizar</a> -->
                                
                                </th>
                            <th scope="col"><a type="button" class="btn btn-danger" href="../../index.php"></a></th>
                            </tr>
                        </thead>
                        ...
                        ?> 
                        <form method="POST" action="../../controlador/medico/MedicoControl.php">
                            <tbody>
                                <tr>
                                ...
                                <td><?php echo($valor->getTelefono());  ?></td>
                                <td><?php echo($valor->getEspecialidad());  ?></td>
                                <td>
                                <div>
                                    <div>
                                        ...
                                        <div class="input-group mb-0">
                                                    ...
                                                    <div >
                                                        ...
                                                        <button class="btn btn-danger"  type="submit" value="des" id="boton" name="boton">-</button>
                                                        <button class="<?php if($valor->getActivo()==0){echo("btn btn-danger");}else{echo("btn btn-success");} ?>"  
                                                         type="submit" value="<?php if($valor->getActivo()==0){echo("activarMedico");} else { echo("desactivarMedico"); } ?>" id="boton" name="boton">
                    ...
                    <?php }} else { ?>
                        <form method="POST" action="../../controlador/medico/MedicoControl.php">
                            <tbody>
                                ...
                                <td><?php echo($_POST['especialidad']);  ?></td>
                                <td>
                                <div>
                                    <div>
                                        <form method="POST" action="../../controlador/medico/MedicoControl.php">
                                                <div class="input-group mb-0">
                                                    ...
                                                    <div >
                                                        <button class="btn btn-primary"  type="submit" value="editar" id="boton" name="boton">Editar</button>
                                                        <button class="btn btn-danger"  type="submit" value="des" id="boton" name="boton">-</button>
                                                        <button class="<?php if($_POST['activo']==0){echo("btn btn-danger");}else{echo("btn btn-success");} ?>"  
                                                         type="submit" value="<?php if($_POST['activo']==0){echo("activarMedico");} else { echo("desactivarMedico"); } ?>" id="boton" name="boton">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
                                                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                                            <path fill-rule="evenodd" d="M15.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                                                            </svg>
